...
class LLMAdventureGame:
    ...
    def setup_ui(self):
        ...
        # 添加调试按钮
        debug_frame = tk.Frame(setup_frame)
        debug_frame.grid(row=2, column=0, columnspan=2, sticky="ew", pady=5)
        
        self.start_button = tk.Button(debug_frame, text="开始 / 重置游戏", command=self.start_game, font=("Helvetica", 10, "bold"), bg="#4CAF50", fg="white", relief=tk.FLAT, padx=10, pady=5)
        self.start_button.pack(side=tk.RIGHT, padx=5)
        
        self.debug_button = tk.Button(debug_frame, text="显示调试信息", command=self.show_debug_info, font=("Helvetica", 10), bg="#FF9800", fg="white", relief=tk.FLAT, padx=10, pady=5)
        ...
        # 使用标准的ScrolledText替代HTMLLabel
        self.story_display = scrolledtext.ScrolledText(story_frame, wrap=tk.WORD, font=("Helvetica", 10), bg="white", fg="#333")
